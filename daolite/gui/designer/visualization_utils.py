...
def show_visualization(parent, image_path, output_text):
    ...
    try:
        ...
        save_button.clicked.connect(lambda: save_visualization_image(parent, image_path))
...
def save_visualization_image(parent, source_path):
    ...
    if filename:
        ...
        try:
            ...
            QMessageBox.information(parent, "Image Saved", f"Visualization saved to {filename}")
        except Exception as e:
            from PyQt5.QtWidgets import QMessageBox
